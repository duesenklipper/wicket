...
public class BehaviorExceptionHandlingTest extends WicketTestCase
{
	...
	{
		public StartPage(IModel<String> model, Behavior... behaviors)
		{
	...
	@Test
	public void defaultExceptionHandling() throws Exception
	{
		try
		{
	...
	@Test
	public void singleBehaviorWithCleanupOnly() throws Exception
	{
		try
		{
			tester.startPage(new StartPage(explodingModel, new Behavior()
			{
				@Override
	...
	@Test
	public void twoBehaviorsWithCleanupOnly() throws Exception
	{
		try
		{
			tester.startPage(new StartPage(explodingModel, new Behavior()
	...
	@Test
	public void singleBehaviorWithRedirect() throws Exception
	{
		tester.startPage(new StartPage(explodingModel, new Behavior()
		{
			@Override
	...
	@Test
	public void secondBehaviorIsCalledEvenWithRedirectInFirst() throws Exception
	{
		tester.startPage(new StartPage(explodingModel, new Behavior()
		{
			@Override
	...
	@Test
	public void secondBehaviorRedirectWins() throws Exception
	{
