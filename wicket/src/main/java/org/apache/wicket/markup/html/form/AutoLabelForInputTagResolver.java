 ...
 */
public class AutoLabelForInputTagResolver implements IComponentResolver
{
	private static final long serialVersionUID = 1L;

	private static Logger logger = LoggerFactory.getLogger(AutoLabelForInputTagResolver.class);
	...
	protected static class AutoLabel extends WebMarkupContainer
	{
		...
		/**
		 * @return the formcomponent this label points to, if any.
		 * @see AutoFormComponentLabelResolver
		 */
