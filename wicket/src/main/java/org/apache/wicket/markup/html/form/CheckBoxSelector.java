...
public class CheckBoxSelector extends AbstractCheckSelector
{
	...
	private final static ResourceReference JS = new ResourceReference(CheckBoxSelector.class,
		"CheckBoxSelector.js");
	...
	public CheckBoxSelector(String id, CheckBox... boxes)
	{
		...
		checkBoxIdArrayLiteral = JavascriptUtils.buildMarkupIdJSArrayLiteral(Arrays.asList(boxes));
	}
