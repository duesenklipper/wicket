...
if (typeof (Wicket.CheckboxSelector) == "undefined") {
	...
	Wicket.CheckboxSelector.updateAllCheckboxes = function(newCheckedState,
			findCheckboxes) {
	 ...
	 *            associated checkboxes
	 */
	Wicket.CheckboxSelector.updateSelectorState = function(selectorId,
			findCheckboxes) {
		var checkboxes = findCheckboxes();
		var allChecked = true;
		for (i in checkboxes) {
	 ...
	 *            associated checkboxes
	 */
	Wicket.CheckboxSelector.attachUpdateHandlers = function(selectorId,
			findCheckboxes) {
		var checkboxes = findCheckboxes();
		for (i in checkboxes) {
	 ...
	 *            associated checkboxes
	 */
	Wicket.CheckboxSelector.initializeSelector = function(selectorId,
			findCheckboxes) {
		var selector = wicketGet(selectorId);
